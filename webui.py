...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(prog='nerfstudio webui',
    ...
    parser.add_argument('--device_type', type=str,
                        default='cuda', help='Type of the devices')
    parser.add_argument('--dist_url', type=str,
                        default='auto', help='Distributed URL')
    parser.add_argument('--machine_rank', type=int,
                        default=0, help='Machine rank')
    parser.add_argument('--num_devices', type=int, default=1,
                        help='Number of processing (GPU) devices')
    parser.add_argument('--num_machines', type=int, default=1,
                        help='Number of available machines')
    ...
    parser.add_argument('--websocket_port', type=int,
                        default=7007, help='Port of the Viser websocket, choose 0 to pick random free port')
    

    parsed_args: argparse.Namespace = parser.parse_args()

    app = WebUI(parsed_args)
    app.launch(inbrowser=True, share=parsed_args.share,
               server_name=parsed_args.server_name, server_port=parsed_args.server_port)
